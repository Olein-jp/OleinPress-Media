 ...
 */
include_once ( get_template_directory() . '/inc/customizer/customize-default/title_tagline/control.php' );
...
if ( ! is_customize_preview() ) {
	 ...
	 */
	include_once ( get_template_directory() . '/inc/customizer/customize-default/title_tagline/preview.php' );
